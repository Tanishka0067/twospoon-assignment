  ...
  return (
    <div className="sm:flex hidden flex-col px-12 p-6 border-2 border-gray-200  bg-white rounded-xl font-[inter] tracking-wide">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between bg-gray-100 p-4 px-8 rounded-xl">
          <div className="flex items-center gap-6">
            <img src={phone} alt="phone" />
            <span className="font-medium">Apple iPhone 14 Pro Max 128Gb</span>
          </div>
          <span className="font-extrabold pl-16 pr-4">$1399</span>
        </div>
        ...
        <div className="flex items-center justify-between bg-gray-100 p-4  px-8 rounded-xl">
          ...
          <span className="font-extrabold pr-4 pl-16">$549</span>
        </div>
        ...
        <div className="flex items-center justify-between bg-gray-100 p-4 px-8 rounded-xl">
          ...
          <span className=" pl-16 pr-4 font-extrabold">$399</span>
        </div>
      </div>
      ...
      {/* Shipment Method */}
      <div className="mt-4">
        <h3 className="text-sm text-gray-500">Shipment method</h3>
